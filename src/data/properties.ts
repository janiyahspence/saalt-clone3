  ...
  },
  {
    ...
    rooms: [
      ...
      },
      {
        ...
        description: 'Spacious suite with separate work area, ideal for extended stays and business travelers.',
        bedType: 'King Bed',
        capacity: 2,
        price: '₹2,200',
    ...
    rooms: [
      {
        ...
        description: 'Spacious 349 sq.ft room with serene garden views, premium furnishings, and modern amenities perfect for couples and leisure travelers.',
        size: '349 sq.ft',
        bedType: 'Double Bed',
        capacity: 2,
        price: '₹4,000',
        amenities: ['Free WiFi', 'AC', 'Smart TV', 'Mini Bar', 'Garden View', 'Premium Bedding', 'Rainfall Shower', 'Luxury Toiletries'],
        images: ['https://images.unsplash.com/photo-1591088398332-8a7791972843?w=800'],
      },
      {
        name: 'Deluxe Room - Pool View',
        description: 'Luxurious 349 sq.ft room overlooking the sparkling swimming pool, offering a perfect blend of elegance and comfort.',
        size: '349 sq.ft',
        bedType: 'Double Bed',
        capacity: 2,
        price: '₹4,500',
